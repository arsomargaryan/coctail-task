...
export default function WineSearch() {
  return <>
    <section  className=" flex justify-center items-center">
      <div  className="flex flex-col items-center justify-between gap-5 text-white bg-[#b02c24] p-7 absolute -bottom-18">
        <div className="font-semibold">We're here to help you make the most of cocktail hour.</div>
        <input 
          type="text" 
          placeholder="Search for..." 
          className="bg-white py-3 px-5 rounded-3xl text-black placeholder-black font-semibold outline-none" 
        />
