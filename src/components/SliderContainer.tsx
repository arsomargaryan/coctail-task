...
export default function SliderContainer() {
  return (
    <div className=" mt-24 h-96 bg-gradient-to-r from-[#e4dca4] via-[#f4f4d4] to-[#e4dca4] relative overflow-hidden">
      ...
      <div className=" absolute bg-[#dee6ac] w-2xl h-40 rotate-[60deg] top-0 left-[6%] lg:left-[15%] xl:left-[30%] z-10"> asda </div>
